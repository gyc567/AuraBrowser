...
async function main() {
  ...
  await fs.writeFile(
    ...
    JSON.stringify({ manifest_version: 3, name: 'Store Fixture', version: '1.2.3' }),
    'utf8'
  );
  ...
  try {
    const result = await addChromeStoreExtension(
      'https://chromewebstore.google.com/detail/fixture/aapbdbdomjkkjkaonfhkkikfgjllcleb',
