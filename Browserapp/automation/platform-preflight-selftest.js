...
// --- Windows on ARM with x64-only kernel ---
{
  const r = platformPreflight({
    platform: 'win32',
    arch: 'arm64',
    env: { USERPROFILE: 'C:\\U', LOCALAPPDATA: 'C:\\U\\L' },
    profileDataRoot: 'C:\\ob',
...
{
  const x11 = platformPreflight({
    platform: 'linux',
    arch: 'x64',
    env: { HOME: '/home/a', XDG_SESSION_TYPE: 'x11' },
  });
  ...
  const way = platformPreflight({
    platform: 'linux',
    arch: 'x64',
    env: { HOME: '/home/a', WAYLAND_DISPLAY: 'wayland-0' },
  });
