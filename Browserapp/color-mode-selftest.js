...
storeValue = null;
ok('no stored value -> auto (follow system)', readSavedColorPreference() === 'auto');
storeValue = 'auto';
ok("stored 'auto' -> auto", readSavedColorPreference() === 'auto');
storeValue = 'light';
ok("stored 'light' -> light", readSavedColorPreference() === 'light');
storeValue = 'dark';
ok("stored 'dark' -> dark", readSavedColorPreference() === 'dark');
storeValue = 'garbage';
ok('stored garbage -> auto', readSavedColorPreference() === 'auto');
