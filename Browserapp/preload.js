...
contextBridge.exposeInMainWorld(
  ...
  Object.freeze({
    ...
    addExtensionStore: (url, profileIds, restart) =>
      ipcRenderer.invoke('extensions:add-store', { url, profileIds, restart }),
    assignExtension: (extensionId, profileIds, enabled) =>
      ipcRenderer.invoke('extensions:assign', { extensionId, profileIds, enabled }),
    toggleExtensionAll: (extensionId, enabled) =>
      ipcRenderer.invoke('extensions:toggle-all', { extensionId, enabled }),
    ...
    textAction: (ids, action, text, delayMin, delayMax) =>
      ipcRenderer.invoke('sync:text', { ids, action, text, delayMin, delayMax }),
    batchTextAction: (ids, texts, delayMin, delayMax) =>
      ipcRenderer.invoke('sync:text-batch', { ids, texts, delayMin, delayMax }),
    ...
    rpaTemplateSyncRemote: (payload) =>
      ipcRenderer.invoke('automation:rpa-template-sync-remote', payload || {}),
    rpaTemplateConfig: (payload) => ipcRenderer.invoke('automation:rpa-template-config', payload || null),
    rpaTemplateImportRemote: (payload) =>
      ipcRenderer.invoke('automation:rpa-template-import-remote', payload || {}),
